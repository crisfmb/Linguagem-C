...
The program should do the following:
 ...
 X 1 - imprimir na tela todas as linhas encontradas
 X 2 - criar uma variavel string que recebe a linha encontrada e imprime na tela
 X 3 - Imprimir o tamanho da variavel string. 
 X 4 - Imprimir as duas ultimas letras da palavra
 5 - Comparar se as letras são ed
 6 - So imprimir as palavras que terminam com ed*/
...
int readData(char *inFilename) // le o arquivo txt de acordo com o nome informado no main
{
    ...
    { //arquivo existe
        ...
        //name = MATRIZ
        //Linha 0->[b,a,n,a,n,a]
        //Linha 1->[a,b,a,c,a,t,e,d]
        //Linha 2->[m,a,c,a,c,o,e,d]
